...
{ text: '🫂 GroupTelegram', url: 'https://t.me/+HIJr9u1KjZwwYjg1' }
    ],
  ];
  ...
  console.log(`Uptime: ${days} hari, ${hours} jam, ${minutes} menit, ${seconds} detik`);
  let jumlahServer = 0;
...
Informasi Bot
*⏰ Uptime Bot :* ${days} hari - ${hours} jam
...
async function handleServiceAction(ctx, action) {
  ...
  if (action === 'create') {
    keyboard = [
      ...
      [{ text: 'Create Vmess', callback_data: 'create_vmess' }, { text: 'Create Vless', callback_data: 'create_vless' }],
      [{ text: 'Create Trojan', callback_data: 'create_trojan' }, { text: 'Create Shdwscks', callback_data: 'create_shadowsocks' }],
    ...
    keyboard = [
      ...
      [{ text: 'Renew Trojan', callback_data: 'renew_trojan' }, { text: 'Renew Shdwscks', callback_data: 'renew_shadowsocks' }],
      [{ text: '🔙 Kembali', callback_data: 'send_main_menu' }]
    ];
  }
  try {
